...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { food_service: @type.food_service, max_person: @type.max_person, name: @type.name, number_bed: @type.number_bed, price: @type.price } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { food_service: @type.food_service, max_person: @type.max_person, name: @type.name, number_bed: @type.number_bed, price: @type.price } }
